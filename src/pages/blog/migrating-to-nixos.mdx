...
packages fast enough while being not easily prone to breaking if active maintenence
is not in place.
...
I had backups of data, but not the configuration — services, firewall rules,
